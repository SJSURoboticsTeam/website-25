    ...
    <div className="page">
      ...
      <section className="hero-video">
        ...
        <div className="hero-video-content container">
          <h1 className="hero-tagline hero-tagline-large">
            Building the future of interdisciplinary robotics together
          </h1>
        </div>
      </section>
      ...
      <section id="divisions">
        <div className="container">
          ...
          >
            ...
            Join our Trial Project Discord
          </a>
        </div>
      </section>
          ...
          <div className="marquee-track">
            ...
            {[...sponsors, ...sponsors].map((sponsor, i) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`sponsor-img-box${sponsor.darkLogo ? " dark-logo" : ""}`}
              >
...
const sponsors = [
  { name: "SJSU Engineering", logo: "/images/sponsors/SJSU-ENGR.png", url: "https://www.sjsu.edu/engineering/" },
  { name: "SJSU Associated Students", logo: "/images/sponsors/SJSU-AS.png", url: "https://as.sjsu.edu" },
  { name: "Google", logo: "/images/sponsors/google.png", url: "https://www.google.com" },
  { name: "Bergman Prototyping", logo: "/images/sponsors/bergman_prototyping.png", url: "https://www.bergmanprototyping.com" },
  { name: "Hamamatsu", logo: "/images/sponsors/hamamatsu.png", url: "https://www.hamamatsu.com" },
  { name: "Industrial Metal Supply", logo: "/images/sponsors/industrial-metal-supply.png", url: "https://www.industrialmetalsupply.com" },
  { name: "Kammace", logo: "/images/sponsors/khalil.png", url: "https://github.com/kammce", darkLogo: true },
  { name: "Libhal", logo: "/images/sponsors/libhal.png", url: "https://libhal.github.io" },
  { name: "xTool", logo: "/images/sponsors/xtool.png", url: "https://www.xtool.com" },
];
